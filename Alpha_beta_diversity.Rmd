...
ps
```
We consider a sample as Clostridium difficile (CD) positive if Clostridium difficile (CD) was detected either the lab assay or
...
and beta diversity analysis. This pruning will likely make very little difference
...
```{r, include = FALSE}
ggsave(("~/Desktop/GitHub/Cdiff/figures/Figure2.pdf"),width = 8, height = 7, units = "in", useDingbats = FALSE)
```
...
```{r, include = FALSE}
ggsave(("~/Desktop/GitHub/Cdiff/figures/InvSimp_CD.pdf"),
